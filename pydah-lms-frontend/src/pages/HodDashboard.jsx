...
const HodDashboard = () => {
              ...
              {cclWorkRequests.map((work) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-lg font-semibold text-primary">
                        {work.employee?.name || 'Unknown Employee'}
                      </h3>
                      <p className="text-sm text-gray-600">ID: {work.employee?.employeeId || 'N/A'}</p>
                    </div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p className="text-gray-700">
                      <span className="font-medium">Date:</span> {new Date(work.date).toLocaleDateString()}
                    </p>
                    <p className="text-gray-700">
                      <span className="font-medium">Work Type:</span> {work.workType}
                    </p>
                    <p className="text-gray-700">
        ...
        return (
          <div className="p-4 sm:p-6 mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-secondary p-6 rounded-neumorphic shadow-outerRaised">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-lg">{hod?.name}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Email</label>
                    <p className="mt-1 text-lg">{hod?.email}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Department</label>
                    <p className="mt-1 text-lg">{hod?.department?.name || hod?.branchCode}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Phone Number</label>
                    <p className="mt-1 text-lg">{hod?.phoneNumber || 'N/A'}</p>
                  </div>
                  <div>
              ...
              {/* Leave Balance */}
              <div className="bg-secondary p-6 rounded-neumorphic shadow-outerRaised">
                <h3 className="text-xl font-semibold text-primary mb-4">Leave Information</h3>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Leave Balance</label>
                    <p className="mt-1 text-2xl font-bold text-primary">{hod?.leaveBalance || 0} days</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">CCL Balance</label>
                    <p className="mt-1 text-2xl font-bold text-primary">{hod?.cclBalance || 0} days</p>
                  </div>
                  <div className="pt-4">
                    <button
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Keep all modals and popups as before, outside the main content area */}
      {/* ...existing modals and popups code... */}
    </div>
  );
};
